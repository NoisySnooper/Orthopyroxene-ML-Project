...
NB04_CODE = _code_cell([
    ...
    '                   .rename(columns={"mean": "tuned_best_rmse",\n',
    '                                    "std":  "tuned_best_std",\n',
    '                                    "model": "tuned_best_model",\n',
    '                                    "feature_set": "tuned_best_fs"}))\n',
    '\n',
    ...
    '\n',
    '    def _verdict(r):\n',
    '        if pd.isna(r["tabpfn_rmse"]) or pd.isna(r["tuned_best_rmse"]):\n',
    '            return "incomplete"\n',
    '        d = r["tabpfn_rmse"] - r["tuned_best_rmse"]\n',
    '        tol = 0.5 * max(r.get("tuned_best_std", 0) or 0, \n',
...
NBF_CODE = _code_cell([
    ...
    '            r = row.iloc[0]\n',
    '            means = [r.get("tuned_best_rmse"), r.get("tabpfn_rmse"),\n',
    '                     r.get("external_best_rmse")]\n',
    '            errs  = [r.get("tuned_best_std", 0), r.get("tabpfn_std", 0),\n',
    '                     0]\n',
...
NB09_CODE = _code_cell([
    ...
    '                     for m, s, tgt in zip(h2h["tuned_best_rmse"],\n',
    '                                           h2h["tuned_best_std"],\n',
    '                                           h2h["target"])],\n',
    '        "tuned_best_model": h2h["tuned_best_model"].fillna(""),\n',
