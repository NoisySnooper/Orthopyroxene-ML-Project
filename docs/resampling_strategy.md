...
Per `docs/v10_nb03_test_protocol.md`, test T03 ("resampling vs none") runs
...
- Per-pipeline test definition: `docs/v10_nb03_test_protocol.md` test T03
- 8-model roster: `docs/v10_master_plan.md` Section 3
- Per-pipeline test log schema: `docs/v10_master_plan.md` Section 7
