...
**2026-04-17 — Initial registration.** Bins fixed at 0/5/15/30/100 kbar. Bias-correction ship rule with `N_MIN_FOR_VETO = 20`, `T_ABS_T = 10.0`, `T_ABS_P = 1.0`, `T_REL = 0.10`. No per-bin V10 results exist at this timestamp (V10 Phase E training in progress). Constants are final.
