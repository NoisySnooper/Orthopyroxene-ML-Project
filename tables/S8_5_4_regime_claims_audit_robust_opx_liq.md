...
Verdict rule: "outperforms" requires BOTH v10_rmse_hi < putirka_rmse_lo (axis 1) AND seed_rmse_hi < putirka_rmse_lo (axis 2) AND n >= 20.

| Regime              | Target   |   n | v10 cell        | v10 RMSE [95% CI]      | Seed RMSE mean [min, max]   | Putirka eq   | Putirka RMSE [95% CI]   | Axis-1 (residual) non-overlap   | Axis-2 (seed) non-overlap   | Robust verdict                   |
|:--------------------|:---------|----:|:----------------|:-----------------------|:----------------------------|:-------------|:------------------------|:--------------------------------|:----------------------------|:---------------------------------|
...
| shallow_crustal     | P_kbar   |  47 | ElasticNet/raw  | 2.66 [2.25, 3.13]      | 2.66 [2.66, 2.66]           | Putirka 29a  | 3.89 [3.24, 4.47]       | True                            | True                        | v10 outperforms Putirka (robust) |
